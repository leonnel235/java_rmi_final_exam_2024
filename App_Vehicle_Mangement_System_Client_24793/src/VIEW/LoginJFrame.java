...
public class LoginJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/VIEW/admin-login-icon-11.jpg"))); // NOI18N
        ...
        jSignup.setBackground(new java.awt.Color(153, 153, 153));
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGap(138, 138, 138)
                                    .addComponent(jTextEmail, javax.swing.GroupLayout.PREFERRED_SIZE, 184, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 0, 1020, 540));
    ...
    private void jSigninActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jSigninActionPerformed
        try {
        if (jTextEmail.getText().trim().isEmpty() || jPassword.getText().trim().isEmpty()) {
            ...
            SignupModel theObj = service.authenticateUser(theSignUp.getEmail(), theSignUp.getPassword());
